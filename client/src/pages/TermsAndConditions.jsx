    ...
    <>
      ...
      <div className="terms-wrapper">
        ...
        <div className="terms-section">
          ...
          <p>
            Welcome to <strong>HavenRent</strong>. These Terms and Conditions
        ...
        <div className="terms-section">
          ...
          <p>
            HavenRent reserves the right to modify these terms at any time.
        ...
        <div className="terms-footer">
          <p>
            Thank you for using <strong>HavenRent</strong>. Your trust matters to
            us.
          </p>
        </div>
      </div>
